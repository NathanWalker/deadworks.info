...
jQuery(function($){
  ...
  if (!Modernizr.canvas){
    ...
    p.mousePressed = function(){
        ...
        for (var i = 0; i < numParticles; i++) {
          ...
          if (pixels[i].flightMode == 1){
            ...
            $('#tweet').html('<h1>' + currentlyPlaying.name + '</h1><span class="duration">' + currentlyPlaying.duration + '</span>' + '<div class="simpleCart_shelfItem" style="left: 118px; top: 0px;">' + '<div class="tooltip" style="display: block;opacity:1;top:-40px; left:71px;">' + '<span class="item_price">$0.99</span>' + '<a href="javascript:;" class="item_add">Add to Cart</a>' + '</div>' + ' <span class="item_name">' + currentlyPlaying.name + '</span>' + '</div>');
    ...
    //			$('#audio').attr('src', '/assets/audio/AllThoseTimes.mp3');
    //		} else {
